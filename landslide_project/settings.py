...
Place this file at: django_app/landslide_project/settings.py
"""
...
# ML Model path — points to the cloned repo's model folder
# Adjust this path to where you cloned mhscience/landslides_detection
